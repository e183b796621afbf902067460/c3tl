...
from overviews.protocols.ellipsis.overview import (
    ...
    EllipsisFarmingPoolIncentiveOverview
)
...
class TestEllipsisFarmingPoolIncentiveOverview(unittest.TestCase):
    ...
    def testInstance(self):
        self.assertIsInstance(self._instance, EllipsisFarmingPoolIncentiveOverview)
