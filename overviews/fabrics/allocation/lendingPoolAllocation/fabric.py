...
from overviews.protocols.sturdy.overview import SturdyLendingPoolAllocationOverview
...
lendingPoolAllocationOverviewFabric.addProduct(protocol='sturdy', overview=SturdyLendingPoolAllocationOverview)
